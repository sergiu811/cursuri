...
import { XIcon, SaveIcon, ImageIcon } from "lucide-react";
...
export function EditCourseDialog({
  ...
  const [errors, setErrors] = React.useState<
    Partial<Record<keyof Course, string>>
  >({});
  ...
  React.useEffect(() => {
    if (course) {
      setFormData(course);
      setHasDiscount(!!course.originalPrice && !!course.discount);
      setIsPublished(course.students !== undefined);
    }
  }, [course]);
